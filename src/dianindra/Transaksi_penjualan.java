/*
 * Created by JFormDesigner on Sat Jan 04 12:44:49 ICT 2014
 */
...
public class Transaksi_penjualan extends JFrame {
    Connection con;
    Statement st;
    ...
    private void transaksi_penjualan_tambahdata(ActionEvent e) {
    ...
    private void initComponents() {
        ...
        setTitle("Dianindra - Transaksi Penjualan");
        ...
        //======== tabbedPane1 ========
        {
            ...
            //======== panel2 ========
            {
                ...
                button1.addActionListener(new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        transaksi_penjualan_tambahdata(e);
                    }
                });
                        ...
                        .addGroup(panel2Layout.createSequentialGroup()
                            ...
                            .addGroup(panel2Layout.createParallelGroup()
                                .addGroup(panel2Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 276, Short.MAX_VALUE)
                                    ...
                                    .addGap(22, 22, 22)
                                    .addComponent(label5, GroupLayout.PREFERRED_SIZE, 78, GroupLayout.PREFERRED_SIZE)
            ...
            tabbedPane1.addTab("Penjualan ", new ImageIcon(getClass().getResource("/dianindra/gambar/home.png")), panel2);
