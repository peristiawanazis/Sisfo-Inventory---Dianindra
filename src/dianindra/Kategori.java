...
public class Kategori extends JFrame {
    ...
    private void kategori_tambahdata(ActionEvent e) {
   ...
   Object selectedCellValue=table1.getValueAt(selectedRow, selectedColumn);
   ResultSet res = cn.executeQuery("SELECT * FROM kategori");
    while (res.next()) {
        String id = res.getString("kategori_obat");
    ...
    private void initComponents() {
        ...
        table1 = new JTable();
         try{
                  ...
                  ResultSet rs = cn.executeQuery("Select * from kategori");
        ...
        setTitle("Dianindra - Kategori Barang");
        ...
        //======== tabbedPane1 ========
        {
            ...
            //======== panel2 ========
            {
                ...
                //---- button1 ----
                button1.setText("Manage Kategori");
                ...
                button4.setIcon(new ImageIcon(getClass().getResource("/dianindra/gambar/x.png")));
            ...
            tabbedPane1.addTab("Kategori ", new ImageIcon(getClass().getResource("/dianindra/gambar/home.png")), panel2);
                        ...
                        .addGroup(contentPaneLayout.createSequentialGroup()
                            .addGroup(contentPaneLayout.createParallelGroup()
                                ...
                                .addGroup(GroupLayout.Alignment.TRAILING, contentPaneLayout.createSequentialGroup()
                                    ...
                                    .addComponent(tabbedPane1, GroupLayout.DEFAULT_SIZE, 441, Short.MAX_VALUE)))
                            .addContainerGap())))
        );
        pack();
