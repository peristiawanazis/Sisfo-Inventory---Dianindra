/*
 * Created by JFormDesigner on Wed Jan 01 15:18:51 ICT 2014
 */
 ...
 * @author ibnu azis
 */
public class Master_barang extends JFrame {
    Connection con;
    Statement cn;
    ...
    private void master_barang_tambahdata(ActionEvent e) {
    ...
    private void kategori(ActionEvent e) {
  ...
  /* private void delete(ActionEvent e) {
   ...
   cn = (Statement) con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
   InputMap im = table1.getInputMap(JTable.WHEN_FOCUSED);
   ActionMap am = table1.getActionMap();
   int selectedRow = table1.getSelectedRow();
   int selectedColumn = table1.getSelectedColumn(); 
   Object selectedCellValue = table1.getValueAt(selectedRow, 0);
   ResultSet res = cn.executeQuery("SELECT * FROM stock");
    while (res.next()) {
        String id = res.getString("no_stock");
        if (id.equals(selectedCellValue) ) {
          res.deleteRow();
    ...
    private void initComponents() {
        ...
        table1 = new JTable();
         try{
                 ...
                 ResultSet rs = cn.executeQuery("Select stock.id_transaksipembelian, stock.id_obat, obat.nama_obat, obat.kategori_obat, stock.harga_jual, stock.harga_beli, stock.stock, obat.limit_stock, stock.expired_stock from stock JOIN obat on stock.id_obat = obat.id_obat");
            // ResultSet rs = cn.executeQuery("Select obat.id_obat, obat.nama_obat, obat.kategori_obat, stock.id_transaksipembelian, stock.stock, from obat join stock on obat.id_obat = stock.id_obat");
        ...
        setTitle("Dianindra - Master Barang");
        ...
        //======== tabbedPane1 ========
        {
            ...
            //======== panel2 ========
            {
                ...
                button4.setIcon(new ImageIcon(getClass().getResource("/dianindra/gambar/master.png")));
                        ...
                        .addGroup(panel2Layout.createSequentialGroup()
                            ...
                            .addGroup(panel2Layout.createParallelGroup()
                                .addGroup(panel2Layout.createSequentialGroup()
                                    ...
                                    .addGap(291, 776, Short.MAX_VALUE))
                                .addGroup(panel2Layout.createSequentialGroup()
                                    .addGroup(panel2Layout.createParallelGroup()
                                        .addGroup(panel2Layout.createSequentialGroup()
                                        ...
                                        .addGroup(panel2Layout.createSequentialGroup()
                                            .addGap(10, 10, 10)
                                            .addComponent(scrollPane1, GroupLayout.DEFAULT_SIZE, 1085, Short.MAX_VALUE)))
                                    .addContainerGap())))
                );
                    ...
                    panel2Layout.createParallelGroup()
                        .addGroup(panel2Layout.createSequentialGroup()
                            ...
                            .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                ...
                                .addComponent(button4))
                            .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                            .addComponent(scrollPane1, GroupLayout.PREFERRED_SIZE, 290, GroupLayout.PREFERRED_SIZE)
                            .addContainerGap(47, Short.MAX_VALUE))
                );
            }
            tabbedPane1.addTab(" Barang", new ImageIcon(getClass().getResource("/dianindra/gambar/home.png")), panel2);
                ...
                .addGroup(contentPaneLayout.createSequentialGroup()
                    ...
                    .addGroup(contentPaneLayout.createParallelGroup()
                        .addGroup(contentPaneLayout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(tree1, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGroup(contentPaneLayout.createSequentialGroup()
                            .addGroup(contentPaneLayout.createParallelGroup()
                                .addGroup(contentPaneLayout.createSequentialGroup()
                                    .addGap(95, 95, 95)
                                ...
                                .addGroup(GroupLayout.Alignment.TRAILING, contentPaneLayout.createSequentialGroup()
                                    ...
                                    .addComponent(tabbedPane1, GroupLayout.DEFAULT_SIZE, 439, Short.MAX_VALUE)))
                            .addContainerGap())))
        );
        pack();
