/*
 * Created by JFormDesigner on Wed Jan 01 18:03:24 ICT 2014
 */
 ...
 * @author ibnu azis
 */
public class Master_supplier extends JFrame {
    Connection con;
    Statement cn;
    ...
    private void initComponents() {
        ...
        table1 = new JTable();
         try{
                  ...
                  ResultSet rs = cn.executeQuery("Select * from supplier");
        ...
        setTitle("Dianindra - Master Supplier");
        ...
        //======== tabbedPane1 ========
        {
            ...
            //======== panel2 ========
            {
                ...
                //---- label4 ----
                label4.setText("Cari Kode & Nama Supplier");
                        ...
                        .addGroup(panel2Layout.createSequentialGroup()
                            ...
                            .addGroup(panel2Layout.createParallelGroup()
                                .addGroup(panel2Layout.createSequentialGroup()
                                    ...
                                    .addComponent(label4, GroupLayout.PREFERRED_SIZE, 183, GroupLayout.PREFERRED_SIZE)
            ...
            tabbedPane1.addTab("Supplier  ", new ImageIcon(getClass().getResource("/dianindra/gambar/home.png")), panel2);
